...
export const getAllTop5Lists = (payload) => api.get(`/top5lists/`, payload)
...
export const checkIfTop5ListExists = (payload) => api.get(`/top5listsE/`, payload)
